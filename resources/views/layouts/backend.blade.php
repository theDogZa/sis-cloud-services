...
<html lang="{{ config('app.locale') }}" class="no-focus">
    ...
    <body>
        ...
        -->
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-modern  enable-cookies" >
            <!-- Side Overlay-->
        ...
        <!-- custom JS -->
        <script src="{{ asset('/js/custom.sis.cloud-services.js') }}"></script>
