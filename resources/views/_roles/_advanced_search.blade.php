                    ...
                    <div class="form-group {{config('theme.layout.search')}}">
                        ...
                        <div>
                            <label class="css-control css-control-lg css-control-primary css-radio">
                                ...
                                <span class="css-control-indicator"></span> {{ucfirst(__('roles.active.text_radio.all'))}}
                            </label>
